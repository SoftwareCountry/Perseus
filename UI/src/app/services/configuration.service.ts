...
import { mappingStateToJsonConfiguration } from '@utils/configuration';
...
export class ConfigurationService {
  ...
  saveConfiguration(configurationName: string): Observable<string> {
    ...
    const jsonConfiguration: string = mappingStateToJsonConfiguration(configurationName, state, arrowCache, constantsCache)
