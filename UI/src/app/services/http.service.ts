...
export class HttpService {
  ...
  configurationByMappingFile(file: File): Observable<ConfigurationWrapper> {
    return this.httpClient.post<ConfigurationWrapper>(API_URLS.getConfigurationByMappingFile(), file)
  }
